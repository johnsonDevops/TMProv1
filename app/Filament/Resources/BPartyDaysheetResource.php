...
use App\Filament\Resources\BPartyDaysheetResource\Pages;
use App\Filament\Resources\BPartyDaysheetResource\RelationManagers;

class BPartyDaysheetResource extends Resource
{
    protected static ?string $model = BPartyDaysheet::class;
    ...
    {
        return [
            'index' => Pages\ListBPartyDaysheets::route('/'),
            'create' => Pages\CreateBPartyDaysheet::route('/create'),
            'edit' => Pages\EditBPartyDaysheet::route('/{record}/edit'),
        ];
    }
}

...
use App\Filament\Resources\CPartyHotelResource\Pages;
use App\Filament\Resources\CPartyHotelResource\RelationManagers;

class CPartyHotelResource extends Resource
{
    protected static ?string $model = CPartyHotel::class;
    ...
    {
        return [
            'index' => Pages\ListCPartyHotels::route('/'),
            'create' => Pages\CreateCPartyHotel::route('/create'),
            'edit' => Pages\EditCPartyHotel::route('/{record}/edit'),
        ];
    }
}

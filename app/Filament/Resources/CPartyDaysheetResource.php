...
use App\Filament\Resources\CPartyDaysheetResource\Pages;
use App\Filament\Resources\CPartyDaysheetResource\RelationManagers;

class CPartyDaysheetResource extends Resource
{
    protected static ?string $model = CPartyDaysheet::class;

    protected static ?string $navigationIcon = 'heroicon-o-clipboard-list';

    protected static ?string $activeNavigationIcon = 'heroicon-s-clipboard-list';

    protected static ?string $navigationGroup = 'C Party';
        ...
        return $table
            ->columns([
                TextColumn::make('event.date')
                    ...
                    ->sortable()
                    ->searchable(),
                TextColumn::make('event.day_type')
                    ->toggleable()
                    ->label('Day Type')
                    ->sortable()
                    ->searchable(),
    ...
    {
        return [
            'index' => Pages\ListCPartyDaysheets::route('/'),
            'create' => Pages\CreateCPartyDaysheet::route('/create'),
            'edit' => Pages\EditCPartyDaysheet::route('/{record}/edit'),
        ];
    }
}

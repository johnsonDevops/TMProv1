...
use App\Filament\Resources\APartyAlertResource\Pages;
use App\Filament\Resources\APartyAlertResource\RelationManagers;

class APartyAlertResource extends Resource
{
    protected static ?string $model = APartyAlert::class;
    ...
    {
        return [
            'index' => Pages\ManageAPartyAlerts::route('/'),
        ];
    }    
}
